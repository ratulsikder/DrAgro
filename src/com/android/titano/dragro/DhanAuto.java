...
public class DhanAuto extends Activity implements SurfaceHolder.Callback{
...
// create a matrix object
   ...
   Bitmap img1 = BitmapFactory.decodeResource(getResources(), R.drawable.dhan_blast_auto);
   img1 = Bitmap.createScaledBitmap(img1, m, m, false);
   
   Bitmap img2 = BitmapFactory.decodeResource(getResources(), R.drawable.dhan_foska_dag_auto);
   img2 = Bitmap.createScaledBitmap(img2, m, m, false);
   
   Bitmap img3 = BitmapFactory.decodeResource(getResources(), R.drawable.dhan_khalpora_auto);
   img3 = Bitmap.createScaledBitmap(img3, m, m, false);
   
   Bitmap img4 = BitmapFactory.decodeResource(getResources(), R.drawable.dhan_patay_badami_auto);
  ...
  Intent image_view=new Intent(DhanAuto.this,Dhan_View.class);
