...
public class GomAuto extends Activity implements SurfaceHolder.Callback{
...
// create a matrix object
   ...
   Bitmap img1 = BitmapFactory.decodeResource(getResources(), R.drawable.gom_kalo_morica_auto);
   img1 = Bitmap.createScaledBitmap(img1, m, m, false);
   
   Bitmap img2 = BitmapFactory.decodeResource(getResources(), R.drawable.gom_patar_dag_auto);
  ...
  Intent image_view=new Intent(GomAuto.this,Gom_View.class);
