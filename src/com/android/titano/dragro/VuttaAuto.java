...
public class VuttaAuto extends Activity implements SurfaceHolder.Callback{
...
// create a matrix object
   ...
   Bitmap img1 = BitmapFactory.decodeResource(getResources(), R.drawable.vutta_moca_o_dana_auto);
   img1 = Bitmap.createScaledBitmap(img1, m, m, false);
   
   Bitmap img2 = BitmapFactory.decodeResource(getResources(), R.drawable.vutta_pata_jholsano_auto);
  ...
  Intent image_view=new Intent(VuttaAuto.this,Vutta_View.class);
