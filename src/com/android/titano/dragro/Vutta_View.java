...
public class Vutta_View extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ab.setBackgroundDrawable(colorDrawable);Intent j= getIntent();
